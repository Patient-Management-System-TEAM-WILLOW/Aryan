          ...
          <li className="mb-3">
            <Dropdown>
              <Dropdown.Toggle variant="light">
                <FaFileMedical /> Bill and Payments
              </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item><Link style={{ textDecoration: 'none' }} to="bills">All Bills</Link>.</Dropdown.Item>
                <Dropdown.Item>Pending Payments</Dropdown.Item>
                <Dropdown.Item>Completed Payments</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </li>
        </ul>
